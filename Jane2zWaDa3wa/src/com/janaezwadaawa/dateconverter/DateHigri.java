...
public class DateHigri {  
    ...
    static double[] kuwaiticalendar(boolean adjust, Calendar calendar) {  
        int adj=0;  
        if(adjust){  
            adj=0;  
        }else{  
    ...
    public static String writeIslamicDate(Calendar calendar) {  
        ...
        double[] iDate = kuwaiticalendar(dayTest, calendar);  
